...
```tsx
import { ConfigProvider, Anchor, Space } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Anchor, Space, Card, Typography } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Anchor, Space, Card } from '@lf39.03/antd';
...
```tsx | pure
import type { AnchorProps } from '@lf39.03/antd';
```
