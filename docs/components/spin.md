...
```tsx
import { ConfigProvider, Spin, Space } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Spin, Space, Card, Typography } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Spin, Space, Card } from '@lf39.03/antd';
...
```tsx | pure
import type { SpinProps } from '@lf39.03/antd';
```
