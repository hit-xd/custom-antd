...
```tsx
import { ConfigProvider, Progress, Space } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Progress, Space, Card, Typography } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Progress, Space, Card } from '@lf39.03/antd';
...
```tsx | pure
import type { ProgressProps } from '@lf39.03/antd';
```
