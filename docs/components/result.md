...
```tsx
import { ConfigProvider, Result, Button } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Result, Button, Card, Typography, Space } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Result, Button, Card } from '@lf39.03/antd';
