...
```tsx
import { ConfigProvider, Layout, Space } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Layout, Space, Card, Typography } from '@lf39.03/antd';
...
```tsx
import { ConfigProvider, Layout, Space, Card } from '@lf39.03/antd';
...
```tsx | pure
import type { LayoutProps } from '@lf39.03/antd';
```
