...
const cssVars = [
  ...Object.entries(tokens.color.brand).map(([key, value]) => [`--wrap-color-brand-${key}`, value]),
  ...
  ['--wrap-color-bg-table-header', tokens.color.fill.tableHeader],
  ['--wrap-color-border', tokens.color.border.base],
  ['--wrap-color-border-strong', tokens.color.border.strong],
  ...
  ['--wrap-component-button-height', `${tokens.component.button.height}px`],
  ['--wrap-component-input-height', `${tokens.component.input.height}px`],
  ['--wrap-component-table-row-height', `${tokens.component.table.rowHeight}px`],
