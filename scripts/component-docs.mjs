...
export const componentDocs = [
  ...
  },
  {
    ...
    category: '通用',
    spec: 'antd',
    summary: '用于展示标题、正文、辅助说明和可编辑文本。',
    basic: `<Typography.Text>这是一段正文内容。</Typography.Text>`,
    advanced: `<Typography><Typography.Title level={4}>客户概览</Typography.Title><Typography.Paragraph>用于展示说明文字和业务摘要。</Typography.Paragraph></Typography>`,
  },
  {
    name: 'Divider',
    title: 'Divider 分割线',
    category: '布局',
    spec: 'antd',
    summary: '用于分隔不同内容组或标记区块标题。',
    basic: `<Divider>分组标题</Divider>`,
    advanced: `<Divider orientation="left" dashed>客户信息</Divider>`,
  },
  {
    name: 'Flex',
    title: 'Flex 弹性布局',
    category: '布局',
    spec: 'antd',
    summary: '用于构建一维弹性排列和对齐关系。',
    imports: ['Button', 'Flex', 'Typography'],
    basic: `<Flex gap="small"><Button>取消</Button><Button type="primary">提交</Button></Flex>`,
    advanced: `<Flex justify="space-between" align="center"><Typography.Text>客户信息</Typography.Text><Button type="link">查看</Button></Flex>`,
  },
  {
    name: 'Grid',
    title: 'Grid 栅格断点',
    category: '布局',
    spec: 'antd',
    summary: '用于读取响应式断点并适配页面布局。',
    imports: ['Grid', 'Typography'],
    basic: `{(() => { const screens = Grid.useBreakpoint(); return <pre>{JSON.stringify(screens, null, 2)}</pre>; })()}`,
    advanced: `{(() => { const screens = Grid.useBreakpoint(); return <Typography.Text>{screens.md ? '桌面布局' : '移动布局'}</Typography.Text>; })()}`,
  },
  {
    name: 'Row',
    title: 'Row 栅格行',
    category: '布局',
    spec: 'antd',
    summary: '用于创建横向栅格行并配合 Col 使用。',
    imports: ['Col', 'Row'],
    basic: `<Row gutter={16}><Col span={12}>左侧</Col><Col span={12}>右侧</Col></Row>`,
    advanced: `<Row gutter={[16, 16]}><Col xs={24} md={8}>概览</Col><Col xs={24} md={16}>明细</Col></Row>`,
  },
  {
    name: 'Col',
    title: 'Col 栅格列',
    category: '布局',
    spec: 'antd',
    summary: '用于创建栅格列和响应式宽度。',
    imports: ['Col', 'Row'],
    basic: `<Row><Col span={12}>半宽内容</Col><Col span={12}>半宽内容</Col></Row>`,
    advanced: `<Row gutter={16}><Col flex="120px">标签</Col><Col flex="auto">内容区域</Col></Row>`,
  },
  {
    name: 'Space',
    title: 'Space 间距',
    category: '布局',
    spec: 'antd',
    summary: '用于在相邻元素之间保持统一间距。',
    imports: ['Button', 'Space'],
    basic: `<Space><Button>取消</Button><Button type="primary">提交</Button></Space>`,
  ...
  },
  {
    ...
    category: '导航',
    spec: 'antd',
    summary: '用于承载更多操作或次级选项。',
    imports: ['Button', 'Dropdown'],
    basic: `<Dropdown menu={{ items: [{ key: 'edit', label: '编辑' }, { key: 'delete', label: '删除' }] }}><Button>更多操作</Button></Dropdown>`,
    advanced: `<Dropdown.Button menu={{ items: [{ key: 'download', label: '下载' }] }}>主操作</Dropdown.Button>`,
  },
  {
    name: 'Menu',
    title: 'Menu 导航菜单',
    category: '导航',
    spec: 'antd',
    summary: '用于页面导航和侧边栏菜单。',
    basic: `<Menu mode="inline" items={[{ key: 'home', label: '首页' }, { key: 'customer', label: '客户管理' }]} />`,
    advanced: `<Menu mode="horizontal" selectedKeys={['customer']} items={[{ key: 'home', label: '首页' }, { key: 'customer', label: '客户管理' }]} />`,
  },
  {
    name: 'AutoComplete',
    ...
    category: '数据录入',
    spec: 'antd',
    summary: '用于在输入过程中提供匹配建议。',
    basic: `<AutoComplete style={{ width: 240 }} options={[{ value: '客户A' }, { value: '客户B' }]} placeholder="搜索客户" />`,
    advanced: `<AutoComplete style={{ width: 280 }} allowClear options={[{ value: '上海分行' }, { value: '北京分行' }]} placeholder="输入机构名称" />`,
  },
  {
    name: 'ColorPicker',
    ...
    category: '数据录入',
    spec: 'antd',
    summary: '用于选择品牌色、标签色或可视化配色。',
    basic: `<ColorPicker defaultValue="#C5A267" />`,
    advanced: `<ColorPicker showText defaultValue="#1874FF" />`,
  },
  {
    name: 'Mentions',
    title: 'Mentions 提及',
  ...
  },
  {
    ...
    spec: 'antd',
    summary: '用于展示或录入评分等级。',
    basic: `<Rate defaultValue={3} />`,
    advanced: `<Rate allowHalf defaultValue={4.5} />`,
  },
  {
    name: 'Calendar',
    title: 'Calendar 日历',
    category: '数据展示',
    spec: 'antd',
    summary: '用于按月展示日期、日程或排班信息。',
    basic: `<Calendar fullscreen={false} />`,
    advanced: `<Calendar fullscreen={false} mode="month" />`,
  },
  {
    name: 'Empty',
    title: 'Empty 空状态',
    category: '数据展示',
    spec: 'antd',
    summary: '用于在内容为空时提供明确反馈。',
    basic: `<Empty description="暂无数据" />`,
    advanced: `<Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="暂无匹配结果" />`,
  },
  {
    name: 'QRCode',
    title: 'QRCode 二维码',
    category: '数据展示',
    spec: 'antd',
    summary: '用于展示可扫码访问的信息入口。',
    basic: `<QRCode value="https://ant.design" />`,
    advanced: `<QRCode value="https://ant.design" status="active" bordered />`,
  },
  {
    name: 'Segmented',
    ...
    category: '数据展示',
    spec: 'antd',
    summary: '用于在少量选项中快速切换视图。',
    basic: `<Segmented options={['日', '周', '月']} />`,
    advanced: `<Segmented block options={['客户', '资产', '交易']} />`,
  },
  {
    name: 'Timeline',
    title: 'Timeline 时间轴',
    category: '数据展示',
    spec: 'antd',
    summary: '用于按时间顺序展示流程节点或事件记录。',
    basic: `<Timeline items={[{ children: '提交申请' }, { children: '部门复核' }, { children: '审批完成' }]} />`,
    advanced: `<Timeline mode="left" items={[{ label: '09:00', children: '提交申请' }, { label: '10:30', children: '审批处理中' }]} />`,
  },
  {
    name: 'Tree',
    title: 'Tree 树形控件',
    category: '数据展示',
    spec: 'antd',
    summary: '用于展示层级结构并支持展开、选择和勾选。',
    basic: `<Tree treeData={[{ title: '总部', key: 'hq', children: [{ title: '财富管理部', key: 'wealth' }] }]} />`,
    advanced: `<Tree checkable defaultExpandAll treeData={[{ title: '总部', key: 'hq', children: [{ title: '运营部', key: 'ops' }] }]} />`,
  },
  {
    name: 'App',
    title: 'App 包裹组件',
    category: '反馈',
    spec: 'antd',
    summary: '用于为 message、modal、notification 等静态方法提供上下文。',
    imports: ['App', 'Button', 'Typography'],
    basic: `<App><Typography.Text>App 为 message、modal、notification 提供上下文。</Typography.Text></App>`,
    advanced: `<App><Button type="primary">上下文内操作</Button></App>`,
  },
  {
    name: 'message',
    title: 'message 全局提示',
    category: '反馈',
    spec: 'antd',
    summary: '用于展示轻量级全局操作反馈。',
    imports: ['Button', 'message'],
    typeName: 'MessageArgsProps',
    basic: `<Button onClick={() => message.success('保存成功')}>显示成功提示</Button>`,
    advanced: `<Button onClick={() => message.loading('处理中', 1)}>显示加载提示</Button>`,
  },
  {
    name: 'notification',
    ...
    category: '反馈',
    spec: 'antd',
    summary: '用于展示较完整的全局通知和风险提醒。',
    imports: ['Button', 'notification'],
    typeName: 'NotificationArgsProps',
    basic: `<Button onClick={() => notification.success({ message: '处理完成' })}>显示通知</Button>`,
    advanced: `<Button onClick={() => notification.warning({ message: '风险提醒', description: '客户风险评估即将到期。' })}>显示风险提醒</Button>`,
  },
];
